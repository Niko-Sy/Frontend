...
const stepTransitionName = computed(() => (stepDirection.value === 'backward' ? 'publish-step-back' : 'publish-step-forward'))
...
<template>
  <PageContainer header-mode="compact" title="发布信息" subtitle="四步完成发布，系统会提示可能重复的信息。">
    <div class="publish-layout">
      <el-card class="publish-card" shadow="never">
        ...
        <Transition :name="stepTransitionName" mode="out-in">
          <div :key="active" class="publish-step-pane">
            ...
            <div v-else class="preview-layout">
              <ItemCard :item="previewItem" :interactive="false" />
              <el-card shadow="never" class="publish-confirm-card">
                <h3>提交后状态</h3>
        ...
        <div class="step-actions publish-step-actions">
      ...
      <aside class="publish-aside glass-panel">
        <h3>发布预览</h3>
        <ItemCard :item="previewItem" dense :interactive="false" />
